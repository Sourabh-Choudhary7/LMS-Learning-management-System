                ...
                <div className="flex justify-center mt-12">
                    <div className="max-w-sm w-full bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <form noValidate action="" onSubmit={handleUpdateUserProfile}>
                                ...
                                <figure>
                                    <label htmlFor="image_uploads" className="cursor-pointer flex">
                                        {editData.previewImage ? (
                                            <img className="w-32 h-32 object-cover rounded-full border-4 border-white" src={editData.previewImage} />
                                        ) : (
                            ...
                            <div className="mx-8">
                                <button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 transition-all ease-in-out duration-300 rounded-lg py-2 text-lg cursor-pointer text-white mb-2">
                                    Update profile
                                </button>
